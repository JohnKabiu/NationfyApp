...
public class LoginFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button eLogin = findViewById(R.id.btlogin);
        eLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(LoginFormActivity.this, com.onetouch.tenant.emanyatta.MainActivity.class);
    ...
    private void ApiForSignup(String user_id,
                                     String f_name, String phone, String picture, String email) {
