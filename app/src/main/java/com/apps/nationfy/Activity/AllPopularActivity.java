...
public class AllPopularActivity extends AppCompatActivity {
        ...
        radioGroupSort.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int Check) {
                ...
                if (Check == R.id.sort_distance) {
                    save_sort=4;
                    if (NetworkUtils.isConnected(AllPopularActivity.this)) {
                        ...
                        RequestQueue rq = Volley.newRequestQueue(AllPopularActivity.this);
    ...
    private void searchFilter() {
        ...
        ArrayAdapter<String> citySpinner = new ArrayAdapter<>(AllPopularActivity.this, R.layout.spinner, cityNameList);
        ...
        ArrayAdapter<String> catSpinner = new ArrayAdapter<>(AllPopularActivity.this, R.layout.spinner, catNameList);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AllPopularActivity.this, FilterSearchActivity.class);
