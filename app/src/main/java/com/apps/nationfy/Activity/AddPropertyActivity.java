...
public class AddPropertyActivity extends AppCompatActivity {
    EditText name, bed, bath, area, amenities, description, price, brosur;
    ...
    public void uploadData() {
        ...
        request.setMethod("POST")
                ...
                .addParameter("brosur", brosur.getText().toString())
