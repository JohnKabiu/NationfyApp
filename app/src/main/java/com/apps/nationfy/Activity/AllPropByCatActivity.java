...
public class AllPropByCatActivity extends AppCompatActivity {
    ...
    ListItem adapter;
    String purpose, bedfilter, bathfilter, valuemin, valuemax, sortdata, valuecity, valuecat, Id;
    ...
    private void searchFilter() {
        ...
        ArrayAdapter<String> citySpinner = new ArrayAdapter<>(AllPropByCatActivity.this, R.layout.spinner, cityNameList);
        ...
        ArrayAdapter<String> catSpinner = new ArrayAdapter<>(AllPropByCatActivity.this, R.layout.spinner, catNameList);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.BYCAT+Id, parameters, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String respo=response.toString();
                        Log.d("responce",respo);
