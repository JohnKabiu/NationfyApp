...
public class AllPropByCityActivity extends AppCompatActivity {
        ...
        radioGroupSort.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int Check) {
                ...
                if (Check == R.id.sort_distance) {
                    save_sort=4;
                    if (NetworkUtils.isConnected(AllPropByCityActivity.this)) {
                        JSONObject parameters = new JSONObject();
                        String lat= MainActivity.sharedPreferences.getString(Constants.Lat,"33.738045");
                        String lon= MainActivity.sharedPreferences.getString(Constants.Lon,"73.084488");
                        RequestQueue rq = Volley.newRequestQueue(AllPropByCityActivity.this);
    ...
    private void searchFilter() {
        ...
        final Spinner category = (Spinner) dialog.findViewById(R.id.category);
        final Spinner city = (Spinner) dialog.findViewById(R.id.city);

        ArrayAdapter<String> citySpinner = new ArrayAdapter<>(AllPropByCityActivity.this, R.layout.spinner, cityNameList);
        ...
        ArrayAdapter<String> catSpinner = new ArrayAdapter<>(AllPropByCityActivity.this, R.layout.spinner, catNameList);
        ...
        final Button btn_buy = (Button) dialog.findViewById(R.id.bt_buy);
        final Button btn_rent = (Button) dialog.findViewById(R.id.bt_rent);
        ...
        final Button allbed = (Button) dialog.findViewById(R.id.allbed);
        final Button bed1 = (Button) dialog.findViewById(R.id.bed1);
        final Button bed2 = (Button) dialog.findViewById(R.id.bed2);
        final Button bed3 = (Button) dialog.findViewById(R.id.bed3);
        final Button bed4 = (Button) dialog.findViewById(R.id.bed4);
        final Button bed5 = (Button) dialog.findViewById(R.id.bed5);
        allbed.setSelected(true);

        final Button allbath = (Button) dialog.findViewById(R.id.allbath);
        final Button bath1 = (Button) dialog.findViewById(R.id.bath1);
        final Button bath2 = (Button) dialog.findViewById(R.id.bath2);
        final Button bath3 = (Button) dialog.findViewById(R.id.bath3);
        final Button bath4 = (Button) dialog.findViewById(R.id.bath4);
        final Button bath5 = (Button) dialog.findViewById(R.id.bath5);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AllPropByCityActivity.this, FilterSearchActivity.class);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.BYCITY+Id, parameters, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String respo=response.toString();
                        Log.d("responce",respo);
