...
public class AllPropActivity extends AppCompatActivity {
        ...
        radioGroupSort.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int Check) {
                ...
                if (Check == R.id.sort_distance) {
                    save_sort=4;
                    if (NetworkUtils.isConnected(AllPropActivity.this)) {
                        ...
                        RequestQueue rq = Volley.newRequestQueue(AllPropActivity.this);
    ...
    private void searchFilter() {
        ...
        ArrayAdapter<String> citySpinner = new ArrayAdapter<>(AllPropActivity.this, R.layout.spinner, cityNameList);
        ...
        ArrayAdapter<String> catSpinner = new ArrayAdapter<>(AllPropActivity.this, R.layout.spinner, catNameList);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AllPropActivity.this, FilterSearchActivity.class);
