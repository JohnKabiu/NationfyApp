...
/**
 * Created by apps on 12/4/2018.
 */

// this class will get the latest version of goestateapp from playtore if the goestateapp is publish into playstore
    ...
    protected void onPostExecute(String s) {
        ...
        if(!Constants.versionname.equals(latestVersion) && (latestVersion!=null)){
            ...
            alert.setTitle(R.string.app_name)
                    ...
                    .setMessage("Please update" +" "+ R.string.app_name+" "+"goestateapp. you have an old version.")
