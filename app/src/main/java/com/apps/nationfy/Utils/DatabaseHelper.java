package com.apps.nationfy.Utils;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String KEY_LUASBANGUNAN = "luasbangunan";
    ...
    public ArrayList<PropertyModels> getFavourite() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setLuasbangunan(cursor.getString(cursor.getColumnIndexOrThrow(KEY_LUASBANGUNAN)));
