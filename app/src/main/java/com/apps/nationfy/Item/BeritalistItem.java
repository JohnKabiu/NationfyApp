...
public class BeritalistItem extends RecyclerView.Adapter<BeritalistItem.ItemRowHolder> {
    ...
    public BeritalistItem(Context context, ArrayList<BeritaModels> dataList, int rowLayout) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_berita_list, parent, false);
