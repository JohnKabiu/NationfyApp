...
public class FullImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fullpath = new File(Environment.getExternalStorageDirectory() +"/apps/"+chat_id+".jpg");

        savebtn= getView.findViewById(R.id.savebtn);
        if(fullpath.exists()){
            savebtn.setVisibility(View.GONE);
            savebtn2.setVisibility(getView.VISIBLE);
        }

        direct = new File(Environment.getExternalStorageDirectory() +"/apps/");
    ...
    public void Savepicture(final boolean isfromshare){
        if(Checkstoragepermision()) {
            ...
            final File direct = new File(Environment.getExternalStorageDirectory() + "/DCIM/apps/");
            progressDialog.show();
