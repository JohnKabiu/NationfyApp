...
public class PropertyModels {
    ...
    public void setPropid(String pId) {
        this.propid = pId;
    }
    ...
    public void setFloorPlan(String nameUser) {
        this.floorPlan = nameUser;
    }
    ...
    public void setGalleryName(String Gname) {
        this.galleryName = Gname;
    }
